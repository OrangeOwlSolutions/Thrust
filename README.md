...
- ```Sort_2_arrays_by_key.cu```: Sorting two arrays by the same key - comparison between two approaches [Sorting 3 arrays by key in CUDA (using Thrust perhaps)](http://stackoverflow.com/questions/6617066/cuda-sort-3-arrays-that-are-already-in-gpu-mem-using-thrust-perhaps/42484689#42484689);
- ```Sort_3_arrays_by_key.cu```: Sorting three arrays by the same key - comparison between two approaches [Sorting 3 arrays by key in CUDA (using Thrust perhaps)](http://stackoverflow.com/questions/6617066/cuda-sort-3-arrays-that-are-already-in-gpu-mem-using-thrust-perhaps/42484689#42484689);
